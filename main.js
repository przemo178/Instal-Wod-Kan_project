...
const slideList = [{
    img: "img/koparka6.jpg",
    text: 'instalacje wodno-kanalizacyjne'
},
{
    img: "img/koparka5.jpg",
    text: 'szamba, oczyszczalnie ścieków'
},
{
    img: "img/lopataWZiemi.jpg",
    text: 'inne prace ziemne'
}];
